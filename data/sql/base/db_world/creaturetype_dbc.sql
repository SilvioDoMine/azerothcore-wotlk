...
--
-- Dumping data for table `creaturetype_dbc`
--

LOCK TABLES `creaturetype_dbc` WRITE;
/*!40000 ALTER TABLE `creaturetype_dbc` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `creaturetype_dbc` ENABLE KEYS */;
UNLOCK TABLES;
